...
<div class="container-fluid content">
    <div class="row">
            ...
            <ol class="breadcrumb">
                ...
                <c:choose>
                    <c:when test="${'classes'.equals(param.manage)}">
                        <li class="active"><label class="breadcrumbFont2">添加班级</label></li>
                    </c:when>
                    <c:when test="${'major'.equals(param.manage)}">
                        <li class="active"><label class="breadcrumbFont2">添加专业</label></li>
                    </c:when>
                    <c:when test="${'course'.equals(param.manage)}">
                        <li class="active"><label class="breadcrumbFont2">添加课程</label></li>
                    </c:when>
                </c:choose>
        ...
        <div class="col-md-10">
            <c:choose>
                <c:when test="${'classes'.equals(param.manage)}">
                    <form class="form-horizontal" action="addSystemServlet?manage=classes" method="post">
                        <h4 class="margin_left">请输入添加信息：</h4><br>
                        <div class="form-group">
                ...
                <c:when test="${'major'.equals(param.manage)}">
                    <form class="form-horizontal" action="addSystemServlet?manage=major" method="post">
                        <h4 class="margin_left">请输入添加信息：</h4><br>
                        <div class="form-group">
                            <label for="inputMajorNo2" class="col-md-2 control-label">专业编号<span
                                    class="required">*</span></label>
                            <div class="col-md-3">
                                <input type="text" class="form-control" id="inputMajorNo2" name="majorNo"
                                       placeholder="专业编号"
                                       required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="inputMajorName2" class="col-md-2 control-label">专业名称<span
                                    class="required">*</span></label>
                            <div class="col-md-3">
                                <input type="text" class="form-control" id="inputMajorName2" name="majorName"
                                       placeholder="专业名称"
                                       required>
                            </div>
                        </div>
                ...
                <c:when test="${'course'.equals(param.manage)}">
                    <form class="form-horizontal" action="addSystemServlet?manage=sclass" method="post">
                        <h4 class="margin_left">请输入添加信息：</h4><br>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <select class="form-control" id="inputMajor" name="major">
                                    <option value="请选择对应专业">请选择对应专业</option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <select class="form-control" name="institute">
                                    <option value="请选择对应学院">请选择对应学院</option>
