    ...
    <div class="row">
        ...
        <div class="col-md-8 col-md-offset-1">
            <ol class="breadcrumb">
                ...
                <li><a href=""><label class="breadcrumbFont1">学生查询</label></a></li>
                <li class="active"><label class="breadcrumbFont2">GPA统计</label></li>
            </ol>
        </div>
        <!--信息表格-->
        <div class="col-md-8 col-md-offset-1 table-responsive">
            <form class="form-inline" action=""
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="${condition.no[0]}" name="no"
                           id="inputNo">
                </div>
                <div class="form-group">
                    <label for="inputName">姓名</label>
                    <input type="text" class="form-control" value="${condition.name[0]}" name="name"
                           id="inputName">
                </div>
                <button type="submit" class="btn btn-default btn-success">查询</button>
            </form>
            <c:if test="${empty requestScope.studentGPAList}">
            ...
            <c:if test="${!empty requestScope.studentGPAList}">
                <table class="table table-striped table-hover" class="data-table" style="margin-top: 20px">
                    ...
                    <c:forEach var="student" items="${requestScope.studentGPAList}"
                               varStatus="status">
                        <%--为奇数行和偶数行设置不同的背景颜色--%>
