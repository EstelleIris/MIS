    ...
    <div class="row">
        ...
        <div class="col-md-8 col-md-offset-1">
            <ol class="breadcrumb">
                ...
                <li><a href="pageServlet?type=教师&currentPage=1&rows=6"><label class="breadcrumbFont1">教师管理</label></a>
                </li>
                <li class="active"><label class="breadcrumbFont2">修改教师信息</label></li>
            </ol>
        </div>
        <div class="col-md-10">
            <form class="form-horizontal" action="modifyServlet?type=teacher" method="post">
                <h4 class="margin_left">请输入修改信息：</h4><br>
                <div class="form-group">
                    <label for="inputNo" class="col-md-2 control-label">教师编号<span
                            class="required">*</span></label>
                    <div class="col-md-3">
                        <input type="text" class="form-control" id="inputNo" name="no" value="${param.no}"
                               required readonly>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="inputAge" class="col-md-2 control-label">年龄<span
                            class="required">*</span></label>
                    <div class="col-md-3">
                        <input type="text" class="form-control" id="inputAge" name="age" value="${param.age}"
                               required>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <select class="form-control" id="inputTitile" name="title">
                            <option value="${param.title}">${param.title}</option>
                ...
                <div class="form-group">
                    <label for="inputPhone" class="col-md-2 control-label">联系电话<span
                            class="required">*</span></label>
                    <div class="col-md-3">
                        <input type="text" class="form-control" id="inputPhone" name="phone" value="${param.phone}"
                               required>
                    </div>
                </div>
                <div class="form-group">
