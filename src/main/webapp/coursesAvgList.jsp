    ...
    <div class="row">
        ...
        <div class="col-md-8 col-md-offset-1">
            <ol class="breadcrumb">
                ...
                <li class="active"><label class="breadcrumbFont2">课程平均成绩</label></li>
            </ol>
        </div>
        <!--信息表格-->
        <div class="col-md-8 col-md-offset-1 table-responsive">
            ...
            <c:if test="${empty requestScope.courseAvgList}">
            ...
            <c:if test="${!empty requestScope.courseAvgList}">
                <table class="table table-striped table-hover" class="data-table" style="margin-top: 20px">
                    ...
                    <c:forEach var="course" items="${requestScope.courseAvgList}"
                               varStatus="status">
                        <%--为奇数行和偶数行设置不同的背景颜色--%>
