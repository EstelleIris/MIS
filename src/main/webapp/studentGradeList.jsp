    ...
    <div class="row">
        ...
        <div class="col-md-8 col-md-offset-1">
            <ol class="breadcrumb">
                ...
                <li class="active"><label class="breadcrumbFont2">成绩统计</label></li>
            </ol>
        </div>
        <!--信息表格-->
        <div class="col-md-8 col-md-offset-1 table-responsive">
            <form class="form-inline" action="studentListServlet?&role=${param.role}&query=condition"
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="cj_Sname02" value="${condition.cj_Sname02[0]}"
                           id="inputName">
                </div>
                <div class="form-group">
                    <label for="inputCourse">课程</label>
