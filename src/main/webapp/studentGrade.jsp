    ...
    <div class="row">
        ...
        <div class="col-md-8 col-md-offset-1">
            <ol class="breadcrumb">
                ...
                <li class="active"><label class="breadcrumbFont2">成绩查询</label></li>
            </ol>
        </div>
        <!--信息表格-->
        <div class="col-md-8 col-md-offset-1 table-responsive">
            <form class="form-inline" action="studentServlet?cj_Sno02=${student.no}&role=${param.role}&query=yearTerm"
                  method="post">
                <div class="form-group">
                    <label for="inputYear">学年</label>
                    <select class="form-control" id="inputYear" name="cj_Year02">
                ...
                <div class="form-group">
                    <label for="inputTerm">学期</label>
                    <select class="form-control" id="inputTerm" name="cj_Term02">
                        <option value="全部">全部</option>
                        <option value="1">1</option>
                        <option value="2">2</option>
                    </select>
                </div>
                <button type="submit" class="btn btn-default btn-success" style="margin-left: 50px">查询</button>
            </form>
